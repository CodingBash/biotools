...
<link href="<c:url value="resources/custom/css/aboutmepage/style.css" />" rel="stylesheet" />
<title>BioTools: About Me</title>
</head>
<body class="white-background">
	...
	<script src="<c:url value="/resources/custom/js/aboutmepage/script.js"/>"></script>
</body>
</html>
...
<link href="<c:url value="resources/custom/css/sequencetranslatorpage/style.css" />"
	rel="stylesheet" />
<title>BioTools: Sequence Translator</title>
</head>
<body class="white-background">
	...
	<script src="<c:url value="/resources/custom/js/sequencetranslatorpage/script.js"/>"></script>
</body>
</html>